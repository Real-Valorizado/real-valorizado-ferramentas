  ...
  return (
    <Fragment>
      <div className='relative inline-block text-left'>
        <div
          className='inline-flex cursor-pointer underline font-bold text-blue-700'
                ...
                return (
                  <div className='py-1' role='none'>
                    <ul>
                      {fields.map((item, idx) => (
                        <li
                          className='text-gray-700 block px-4 py-2 text-sm cursor-pointer hover:bg-blue-100 hover:text-slate-900'
                          key={`${item.value}-${idx}`}
